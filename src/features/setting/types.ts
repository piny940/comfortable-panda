...
export class Settings {
  ...
  getTextColor() {
    return this.appInfo.useDarkTheme
      ? CSTheme.dark.textColor
      : CSTheme.light.textColor
  }

  getBgColor() {
    return this.appInfo.useDarkTheme
      ? CSTheme.dark.bgColor
      : CSTheme.light.bgColor
  }

  getDateColor() {
    return this.appInfo.useDarkTheme
      ? CSTheme.dark.dateColor
      : CSTheme.light.dateColor
  }
}
