...
export function SettingsTab(props: {
  ...
  const topColorDangerDesc = useTranslationArgsDeps(
    "settings_colors_hour",
    ["Tab Bar", "24"],
    []
  )
  const topColorWarningDesc = useTranslationArgsDeps(
    "settings_colors_day",
    ["Tab Bar", "5"],
    []
  )
  const topColorSuccessDesc = useTranslationArgsDeps(
    "settings_colors_day",
    ["Tab Bar", "14"],
    []
  )
  const topColorOtherDesc = useTranslationArgsDeps(
    "settings_colors_day_more",
    ["Tab Bar", "14"],
    []
  )

  const miniColorDangerDesc = useTranslationArgsDeps(
    "settings_colors_hour",
    ["miniPandA", "24"],
    []
  )
  const miniColorWarningDesc = useTranslationArgsDeps(
    "settings_colors_day",
    ["miniPandA", "5"],
    []
  )
  const miniColorSuccessDesc = useTranslationArgsDeps(
    "settings_colors_day",
    ["miniPandA", "14"],
    []
  )
  const miniColorOtherDesc = useTranslationArgsDeps(
    "settings_colors_day_more",
    ["miniPandA", "14"],
    []
  )
...
function TranslatedBooleanItem(props: {
  ...
  const description = useTranslationDeps(props.descriptionTag, [
