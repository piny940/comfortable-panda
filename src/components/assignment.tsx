...
export default function AssignmentEntryView(props: {
  ...
  const dueTime = props.assignment.isDuePassed(CurrentTime)
    ? props.assignment.closeTime
    : props.assignment.dueTime
  ...
  return (
    <>
      {!props.isSubset ? (
        ...
        <span className="cs-assignment-date cs-assignmate-date-padding">
          {dueDateString}
        </span>
      )}
